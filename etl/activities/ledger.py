...
@activity.defn
async def get_prices_batch(params: UpdatePricesWorkflowParams) -> list[LedgerPriceOutTemporalDTO]:
    return await UpdatePricesUseCase().execute(params.tickers, params.batch_size)

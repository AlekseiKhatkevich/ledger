...
with workflow.unsafe.imports_passed_through():
    ...
    from workflows.ledger import UpsertTicketsWorkflow, UpdatePricesWorkflow
...
async def main() -> None:
    worker_data = WorkerData(
        ...
        workflows=[UpsertTicketsWorkflow, UpdatePricesWorkflow],
        activities=[upsert_tickers, get_prices_batch],
    )
